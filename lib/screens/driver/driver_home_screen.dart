    ...
    return Container(
      ...
      child: Column(
        children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Container(width: 2, height: 28, color: context.colors.borderColor),
                    Container(
                      width: 10,
                      height: 10,
          ...
          Row(
            children: [
              _infoChip(context, Icons.calendar_today_rounded, '${ride.date}  ·  ${ride.time}'),
              const SizedBox(width: 8),
              _infoChip(context, Icons.airline_seat_recline_normal_rounded,
          ...
          Row(
            children: [
              if (bookedCount > 0)
                ...
                Icon(Icons.person_outline, size: 24, color: context.colors.textTertiary),
              const SizedBox(width: 8),
              Expanded(
                child: Text(
              ...
              Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    const Icon(Icons.check_circle, color: AppStyles.successColor, size: 14),
